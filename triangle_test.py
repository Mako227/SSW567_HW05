"""
   File Name:    triangle_test.py
   Author:       Alan Clark
   Date:         9 Oct 2021
   Description:  Test the classify_triangle function in triangle_amc.py using unittest instances
"""

from triangle_amc import classify_triangle
import unittest

# Class of functions to test classify_triangle()
class TestHW05Function(unittest.TestCase):
